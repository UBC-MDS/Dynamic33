...
In order to better understand patterns in this data, we can use the `ggplot2` package by @ggplot2_pkg to visualize the above contingency table as a two-dimensional histogram, a.k.a heat map (@fig-heatmap).
